...
export interface SimulateMerge {
  performSimulation(type: 'merge' | 'rebase' | 'squash', { baseBranch, targetBranch, commitTitle, commitMessage }: { baseBranch: string, targetBranch: string, commitTitle: string, commitMessage: string }): Promise<GitHubCommit[]>;
  merge: ({ baseBranch, targetBranch, commitTitle, commitMessage }: { baseBranch: string, targetBranch: string, commitTitle: string, commitMessage: string }) => Promise<GitHubCommit[]>;
  squash: ({ baseBranch, targetBranch, commitTitle, commitMessage }: { baseBranch: string, targetBranch: string, commitTitle: string, commitMessage: string }) => Promise<GitHubCommit[]>;
  rebase: ({ baseBranch, targetBranch, commitTitle, commitMessage }: { baseBranch: string, targetBranch: string, commitTitle: string, commitMessage: string }) => Promise<GitHubCommit[]>;
}
...
export class SimulateMergeImpl implements SimulateMerge {
  ...
  async squash({ baseBranch, targetBranch, commitTitle, commitMessage }: { baseBranch: string, targetBranch: string, commitTitle: string, commitMessage: string }) {
    const commitReference = await this.git.getLatestCommitOnBranch({exec: this.exec, branch: targetBranch});
  ...
  async rebase({ baseBranch, targetBranch, commitTitle, commitMessage }: { baseBranch: string, targetBranch: string, commitTitle: string, commitMessage: string }) {
    const commitReference = await this.git.getLatestCommitOnBranch({exec: this.exec, branch: targetBranch});
